...
MqttClient::MqttClient() : m_client(nullptr), m_connected(false) { esp_log_level_set(TAG, ESP_LOG_INFO); }
...
esp_err_t MqttClient::mqtt_event_handler_cb(esp_mqtt_event_handle_t event) { // esp_mqtt_client_handle_t client = event->client;
